...
> [!NOTE]
> **非官方社区版声明**：\
> 　本项目与 [Koishi 官方组织](https://github.com/koishijs) 无隶属关系。基于 [koishijs/koishi](https://github.com/koishijs/koishi) (MIT) 与 [koishijs/webui](https://github.com/koishijs/webui) (部分 AGPL-3.0) 源码按文件级重构为单仓发布。详见 [NOTICE](./NOTICE) 与 [上游对齐映射](./docs/process/upstream.md)
